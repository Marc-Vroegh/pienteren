      ...
      <div class="scrollbar-hide bg-neutral-700 bg-opacity-95 rounded-2xl p-5 w-[680px] h-[620px] overflow-y-auto">
        ...
        <div class="m-3">
            ...
            <div class="relative z-10">
                ...
                <div id="input-container" class="text-center">
                    <input id="toggle-input" type="text" class="w-full bg-opacity-90 bg-white rounded-lg focus:outline-none px-1 py-1" placeholder="Enter in a name for the new dashboard..." name="name"/>
                </div>
        ...
        <div class="flex flex-wrap justify-stretch">
          @foreach ($perm[1] as $dashboard)
            <div class="viewport-custom m-3 p-3 rounded-lg bg-neutral-800 w-[296px]">
              <h3 class="text-white">{{ $dashboard->name }}</h3>
              <div class="scrollbar-hide overflow-scroll h-full max-h-48">
